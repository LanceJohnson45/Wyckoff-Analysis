...
PG_ENABLED/PG_DSN 或 PG_HOST/PG_PORT/PG_DATABASE/PG_USER/PG_PASSWORD(数据库),
SUPABASE_USER_ID(仅 Step4 用户维度标识), TG_BOT_TOKEN, TG_CHAT_ID,
MY_PORTFOLIO_STATE(可选兜底), STEP3_SKIP_LLM(可选),
DAILY_JOB_SKIP_STEP4(可选), LOGS_DIR(可选)
"""
...
def main() -> int:
    ...
    # 也可通过 DAILY_JOB_REQUIRE_STEP3_REPORT 强制要求成功产出。
    step3_ok = True
    step3_err = None
